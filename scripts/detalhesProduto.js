document.addEventListener('DOMContentLoaded', () => {
  const produtosData = {
    ...
    "Bicicleta Monaco Aro 29": {
        imagem: "produtos-bikes/29monaco.webp",
    ...
    "Bicicleta aro 26 | Cor Laranja": {
        imagem: "produtos-bikes/bike-laranja-26.webp",
    ...
    "Bicicleta aro 26 | Cor Branca": {
        imagem: "produtos-bikes/bike-branca-26.webp",
        titulo: "Bicicleta aro 26 | Cor Branca"
    },

    "Bicicleta aro 26 | Cor Verde": {
        imagem: "produtos-bikes/bike-verde-26.webp",
    ...
    "Cadeado Evolo C/ chave | P": {
        imagem: "produtos-acessorios/cadeado-evele-amplo.webp",
  ...
  document.querySelectorAll('.view-button, .view-button-vip').forEach(button => {
